...
# 主调度逻辑
inputfile="D:\\verlog\\2_Verilog编译器\\demo2_电路网表图绘制\\demo2_电路网表图绘制\\output\\output.blif"
and_duration=int(input("请输入and门的耗时:"))
or_duration=int(input("请输入or门的耗时:"))
not_duration=int(input("请输入not门的耗时:"))
...
and_limit=int(input("请输入and门的资源数:"))
or_limit=int(input("请输入or门的资源数:"))
not_limit=int(input("请输入not门的资源数:"))
print("已加载资源，是否继续？(y/n)")
